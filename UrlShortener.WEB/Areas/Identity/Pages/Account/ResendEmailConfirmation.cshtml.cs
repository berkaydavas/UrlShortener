...
public class ResendEmailConfirmationModel : PageModel
{
  ...
  public async Task<IActionResult> OnPostAsync()
  {
    ...
    if (callbackUrl != null)
      await _emailSender.SendEmailAsync(Input.Email, "Hesap Doðrulama", $"Hesabýnýzý doðrulamak için <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>týklayýnýz</a>.");

    ModelState.AddModelError(string.Empty, "Doðrulama e-postasý gönderildi. E-posta kutunuzu kontrol ediniz.");
    return Page();
  }
}