namespace UrlShortener.Migrations
{
    ...
    public partial class StartApp : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Url = c.String(nullable: false, maxLength: 9999, storeType: "nvarchar"),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ShortedUrls", "UserId", "dbo.Users");
            DropForeignKey("dbo.UserRoles", "RoleId", "dbo.Roles");
            DropIndex("dbo.UserLogins", new[] { "IdentityUser_Id" });
            DropIndex("dbo.UserClaims", new[] { "IdentityUser_Id" });
            DropIndex("dbo.Users", "UserNameIndex");
            DropIndex("dbo.ShortedUrls", new[] { "UserId" });
            DropIndex("dbo.ShortedUrls", new[] { "Code" });
